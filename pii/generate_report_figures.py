...
plt.tight_layout()
fig1_path = os.path.join(ASSET_DIR, 'fig1_asset_distribution.png')
plt.savefig(fig1_path)
plt.close()
print(f"[INFO] Saved asset distribution histogram to: {fig1_path}")
...
plt.tight_layout()
fig2_path = os.path.join(ASSET_DIR, 'fig2_sector_exposure.png')
plt.savefig(fig2_path)
plt.close()
print(f"[INFO] Saved sector exposure pie chart to: {fig2_path}")
...
plt.tight_layout()
fig3_path = os.path.join(ASSET_DIR, 'fig3_spouse_gender_heatmap.png')
plt.savefig(fig3_path)
plt.close()
print(f"[INFO] Saved spouse gender heatmap to: {fig3_path}")
